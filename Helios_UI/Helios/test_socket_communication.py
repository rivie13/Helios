...
class TestSocketCommunication:
    ...
    def test_socket_server_initialization(self, mock_set_central, mock_tab_widget, mock_socket):
    ...
    @patch('main.QTabWidget')
    @patch('main.QMainWindow.setCentralWidget')
    def test_socket_server_threading(self, mock_set_central, mock_tab_widget, mock_socket, mock_thread):
    ...
    @patch('main.QTabWidget')
    @patch('main.QMainWindow.setCentralWidget')
    def test_sensor_data_signal_emission(self, mock_set_central, mock_tab_widget, mock_socket):
    ...
    @patch('main.QTabWidget')
    @patch('main.QMainWindow.setCentralWidget')
    def test_simulation_command_sending(self, mock_set_central, mock_tab_widget):
